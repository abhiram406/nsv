...
# ---------------------------
LEFT_WIDTH, RIGHT_WIDTH = 300, 420
...
class NSVApp(ctk.CTk):
    ...
    def build_left_panel(self, f):
        ...
        for i in range(6):
            ...
            chk.grid(row=sens_row + (i//2), column=i%2, sticky="w", padx=2, pady=2)
...
if __name__ == "__main__":
    ...
    #splash.geometry("500x400")  # Small popup size; adjust as needed
    try:
        logo_img = ctk.CTkImage(light_image=Image.open(LOGO_PATH), size=(150,150))  # Adjust size to fit your logo
