"""
NSV Controller v13 — dynamic, larger header (blue bar) + record-size media + labeled telemetry
...
- Right panel shows explicit labels for Speed, Distance, and Chainage.
"""
...
CAM_URLS = [
    "rtsp://username:password@192.168.1.10:554/stream1",  # Front - replace with actual URL
    "rtsp://username:password@192.168.1.11:554/stream1",  # Left - replace with actual URL
    "rtsp://username:password@192.168.1.12:554/stream1",  # Right - replace with actual URL
    "rtsp://username:password@192.168.1.13:554/stream1"   # Back - replace with actual URL
]
...
GRID_COLOR  = "#263238"
SPINE_COLOR = "#607d8b"
HEADER_MAX_FRAC = 0.35       # header can grow up to 35% of frame height
HEADER_LINES = 4             # lines per column
...
class NSVApp(ctk.CTk):
    def __init__(self):
        ...
        self.sensor_selected = [tk.BooleanVar(value=True) for _ in range(SENSORS)]
        ...
        self.selected_sensor_indices = list(range(SENSORS))
    ...
    def build_left_panel(self, f):
        ...
        # Removed sensor selection from here
    ...
    def build_right_panel(self, parent):
        ...
        btns = ctk.CTkFrame(f)
        btns.grid(row=6, column=0, sticky="ew", padx=10, pady=(8,6))
    ...
    def set_selection_state(self, enabled: bool):
        ...
        # sensor checkboxes now in calibration, no need
